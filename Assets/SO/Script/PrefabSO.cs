...
public class PrefabSO : ScriptableObject
{
    ...
    public GameObject _winCondition, _wall, _semiWall, _murBloobPlein, _murBloobVide, _bloobPlein, _bloobVide, _piks, _projectile, _inertieBoost, _star, _blackHole, _previsuPlayer, _previsuWinCondition;
}
