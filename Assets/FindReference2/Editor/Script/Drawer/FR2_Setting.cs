    ...
    internal class FR2_Setting
    {
        ...
        */
        ...
        public void DrawSettings()
        {
            ...
            {
                DrawToggleLeft("Alternate Row Color", ref s.alternateColor);
                DrawToggleLeft("Usage Count in Project Panel", ref s.referenceCount);
        ...
        private void DrawToggleLeft(string label, ref bool value)
        {
