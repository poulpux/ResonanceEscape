...
namespace vietlabs.fr2
{
    internal partial class FR2_Cache
    {
        ...
        {
            if (AssetMap == null) return null; // Still null after Check4Changes, cache not ready
        ...
        internal List<FR2_Asset> FindAssetsOfType(FR2_Asset.AssetType type)
        {
            ...
            if (AssetMap == null) return result; // Still null after Check4Changes, cache not ready
